...
from models.networks.generative.vae.highway import Highway
import torch as t
import torch.nn as nn
import torch.nn.functional as F
from models.networks.embeddings.embedding import Embedding
from utils.misc import kld_coef, parameters_allocation_check, fold
...
class RVAE(nn.Module):
    def __init__(self, params):
        ...
        self.params = params
        self.embedding = Embedding(self.params, self.params.embedding_path)
    ...
    def forward(self, drop_prob,
        ...
        :param initial_state: initial state of decoder recurrent in order to perform sampling
        ...
        :return: unnormalized logits of sentence words distribution probabilities
                 ...
                 final recurrent state with shape of [num_layers, batch_size, decoder_rnn_size]
        """
...
class Encoder(nn.Module):
    ...
    def forward(self, input):
        ...
        ''' Unfold recurrent with zero initial state and get its final state from the last layer
        '''
...
class Decoder(nn.Module):
    ...
    def forward(self, decoder_input, z, drop_prob, initial_state=None):
        ...
        :param drop_prob: probability of an element of decoder input to be zeroed in sense of dropout
        :param initial_state: initial state of decoder recurrent
        ...
        '''
            decoder recurrent is conditioned on context via additional bias = W_cond * z to every input token
        '''
