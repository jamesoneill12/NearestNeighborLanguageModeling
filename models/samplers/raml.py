...
def sample_ngram(src_sents, tgt_sents):
...
def sample_ngram_adapt(args, src_sents, tgt_sents):
    f_out = open(args.output, 'w')
...
def sample_from_hamming_distance_payoff_distribution(src_sents, tgt_sents):
     # do not read in <s> and </s>
    f_out = open(args.output, 'w')
