...
class TDNN(nn.Module):
    def __init__(self, params):
        ...
        self.kernels = [Parameter(torch.Tensor(out_dim, self.params.char_embed_size, kW).uniform_(-1, 1))
    ...
    def forward(self, x):
        ...
        applies multikernel 1d-conv layer along every word in input with max-over-time pooling
