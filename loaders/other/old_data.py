...
import torch
import numpy as np
from loaders.other import embedding_dict, clean_str
...
class Corpus(object):
    def __init__(self, path, emb_type=None, clean=False, limit=None,
                 pretrain=False, ns=False, reward=False, lcs=False):
        ...
        self.train = tokenizer(train_path, limit=self.limit, clean=clean, lcs=lcs)
    ...
    def tokenize(self, path, limit=None, clean=False, lcs=False):
